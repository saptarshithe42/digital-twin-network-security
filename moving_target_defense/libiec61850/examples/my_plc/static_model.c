 ...
 * static_model.c
 *
 * automatically generated from server_scl.icd
 */
...
extern DataSetEntry iedModelds_LogicalDevice_LLN0_Measurements_fcda2;
...
DataSetEntry iedModelds_LogicalDevice_LLN0_Measurements_fcda1 = {
  "LogicalDevice",
  false,
  "GGIO1$MX$OpeningPressure$mag$f", 
  -1,
  NULL,
  NULL,
  &iedModelds_LogicalDevice_LLN0_Measurements_fcda2
};

DataSetEntry iedModelds_LogicalDevice_LLN0_Measurements_fcda2 = {
  "LogicalDevice",
  false,
  "GGIO1$MX$CoilStatus$mag$f", 
  -1,
  NULL,
  NULL,
  NULL
...
DataObject iedModel_LogicalDevice_GGIO1_CurrentPressure = {
    ...
    "CurrentPressure",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure,
...
DataObject iedModel_LogicalDevice_GGIO1_OpeningPressure = {
    DataObjectModelType,
    "OpeningPressure",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure_mag,
    0,
    -1
};

DataAttribute iedModel_LogicalDevice_GGIO1_OpeningPressure_mag = {
    DataAttributeModelType,
    "mag",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure_q,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure_mag_f,
    0,
    -1,
    IEC61850_FC_MX,
    IEC61850_CONSTRUCTED,
...
DataAttribute iedModel_LogicalDevice_GGIO1_OpeningPressure_mag_f = {
    DataAttributeModelType,
    "f",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure_mag,
    NULL,
...
DataAttribute iedModel_LogicalDevice_GGIO1_OpeningPressure_q = {
    DataAttributeModelType,
    "q",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure_t,
    NULL,
    0,
    -1,
    IEC61850_FC_MX,
...
DataAttribute iedModel_LogicalDevice_GGIO1_OpeningPressure_t = {
    DataAttributeModelType,
    "t",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_OpeningPressure,
    NULL,
...
DataObject iedModel_LogicalDevice_GGIO1_CoilStatus = {
    DataObjectModelType,
    "CoilStatus",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1,
    NULL,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus_mag,
    0,
    -1
};

DataAttribute iedModel_LogicalDevice_GGIO1_CoilStatus_mag = {
    DataAttributeModelType,
    "mag",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus_q,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus_mag_f,
    0,
    -1,
    IEC61850_FC_MX,
    IEC61850_CONSTRUCTED,
...
DataAttribute iedModel_LogicalDevice_GGIO1_CoilStatus_mag_f = {
    DataAttributeModelType,
    "f",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus_mag,
    NULL,
...
DataAttribute iedModel_LogicalDevice_GGIO1_CoilStatus_q = {
    DataAttributeModelType,
    "q",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus,
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus_t,
    NULL,
    0,
    -1,
    IEC61850_FC_MX,
...
DataAttribute iedModel_LogicalDevice_GGIO1_CoilStatus_t = {
    DataAttributeModelType,
    "t",
    (ModelNode*) &iedModel_LogicalDevice_GGIO1_CoilStatus,
    NULL,
